...
public class PageRank {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < 2*numRepititions; i++) {
            ...
            if(i%2 == 0) {
            	leftover = job.getCounters().findCounter(mycounter.MY_COUNTER.DANGLING_MASS).getValue();
                size = job.getCounters().findCounter(mycounter.MY_COUNTER.NODE_NUM).getValue();
            } else {
            	leftover = 0;
                size = 0;
            }
